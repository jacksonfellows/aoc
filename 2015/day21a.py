    ...
    for armor_cost, armor_armor in ((0,0),(13,1),(31,2),(53,3),(75,5),(102,5)):
        for ring1_cost, ring1_damage, ring1_armor in ring_info:
            for ring2_cost, ring2_damage, ring2_armor in ring_info:
                if win_fight(damage=weapon_damage+ring1_damage+ring2_damage, armor=armor_armor+ring1_armor+ring2_armor):
                    min_gold = min(min_gold, weapon_cost+armor_cost+ring1_cost+ring2_cost)
print(min_gold)